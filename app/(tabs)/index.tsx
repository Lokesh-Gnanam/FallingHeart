...
import { Heart, Bell, HeartOff } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerLeft}>
          <Heart size={22} color={COLORS.primary} strokeWidth={2.5} fill={COLORS.primary} />
          <Text style={styles.headerTitle}>FallingHearts</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  comboBadge: {
    backgroundColor: 'rgba(255, 255, 255, 0.8)',
    borderWidth: 1.5,
    borderColor: 'rgba(172, 36, 113, 0.3)',
    borderRadius: 16,
  ...
  gameArea: {
    ...
    overflow: 'hidden',
    zIndex: 5,
    marginBottom: 80, // Leave space for custom tab bar overlay
  },
});
